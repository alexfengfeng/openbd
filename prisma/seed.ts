...
#design`,
  ...
  console.log('创建标签模板:', tagTemplates.length, '个');
...
#performance`,
  ...
  console.log('创建标签模板:', tagTemplates2.length, '个');
